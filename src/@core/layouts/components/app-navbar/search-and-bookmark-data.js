...
export default {
  pages: {
    ...
    data: [
      ...
      { title: 'Web PageElement', route: { name: 'page-element-management' }, icon: 'PackageIcon', isBookmarked: false },
      { title: 'Web TestCase', route: { name: 'test-case-management' }, icon: 'OctagonIcon', isBookmarked: false },
