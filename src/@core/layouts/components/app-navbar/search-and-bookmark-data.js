...
export default {
  pages: {
    ...
    data: [
      ...
      { title: 'ChatGroup', route: { name: 'apps-chat' }, icon: 'MessageSquareIcon', isBookmarked: true },
      ...
      { title: 'MyTask', route: { name: 'apps-todo' }, icon: 'CheckSquareIcon', isBookmarked: true },
      ...
      { title: 'Customer Edit', route: { name: 'apps-users-edit', params: { id: 21 } }, icon: 'UserIcon', isBookmarked: false },
      { title: 'Customer List', route: { name: 'apps-users-list' }, icon: 'UserIcon', isBookmarked: false },
      { title: 'Customer View', route: { name: 'apps-users-view', params: { id: 21 } }, icon: 'UserIcon', isBookmarked: false },
      ...
      { title: 'PageElement Management', route: { name: 'app-element-management' }, icon: 'KeyIcon', isBookmarked: false },
      { title: 'TestCase Management', route: { name: 'app-case-management' }, icon: 'InboxIcon', isBookmarked: false },
      { title: 'Execution', route: { name: 'app-page-execution' }, icon: 'FlagIcon', isBookmarked: false },
      { title: 'TestReport', route: { name: 'app-test-report' }, icon: 'SunriseIcon', isBookmarked: false },
      { title: 'Web PM', route: { name: 'page-element-management' }, icon: 'PackageIcon', isBookmarked: false },
      { title: 'Web PageElement', route: { name: 'test-case-management' }, icon: 'OctagonIcon', isBookmarked: false },
      { title: 'Web TestSuits', route: { name: 'web-test-suits' }, icon: 'AirplayIcon', isBookmarked: false },
      { title: 'WebUI Execution', route: { name: 'web-page-execution' }, icon: 'PenToolIcon', isBookmarked: false },
      { title: 'WebUI TestReport', route: { name: 'web-test-report' }, icon: 'PaperclipIcon', isBookmarked: false },
      { title: 'Interface Api', route: { name: 'interface-management' }, icon: 'ActivityIcon', isBookmarked: false },
      { title: 'InterfaceScene', route: { name: 'interface-scene-management' }, icon: 'GithubIcon', isBookmarked: false },
      { title: 'Api Debugging', route: { name: 'interface-debugging-execution' }, icon: 'CastIcon', isBookmarked: false },
      { title: 'Api Execution', route: { name: 'interface-page-execution' }, icon: 'BellIcon', isBookmarked: false },
      { title: 'Api TestReport', route: { name: 'interface-test-report' }, icon: 'AwardIcon', isBookmarked: false },
      { title: 'Roles', route: { name: 'apps-roles' }, icon: 'AlertTriangleIcon', isBookmarked: false },
      { title: 'Permission', route: { name: 'apps-permission' }, icon: 'CreditCardIcon', isBookmarked: false },
      { title: 'Drive Resources', route: { name: 'drive-resource' }, icon: 'FolderMinusIcon', isBookmarked: false },
      { title: 'Log Common', route: { name: 'log-common' }, icon: 'PrinterIcon', isBookmarked: false },
      { title: 'Message Robot', route: { name: 'message-robot' }, icon: 'GitlabIcon', isBookmarked: false },
      { title: 'Mobile Resources', route: { name: 'mobile-resources' }, icon: 'FolderPlusIcon', isBookmarked: false },
      { title: 'Timed Task', route: { name: 'time-task' }, icon: 'RadioIcon', isBookmarked: false },
    ],
  },
  files: {
    key: 'file_name',
